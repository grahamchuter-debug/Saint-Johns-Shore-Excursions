  ...
  return (
    <section className="rounded-xl bg-slate-900 px-6 py-8 text-white md:px-8">
      ...
      <p className="mt-2 max-w-2xl text-slate-300">
        Tell us your ship, port hours, and interests — we&apos;ll suggest St.
        John&apos;s, Newfoundland and Labrador shore excursions that fit your
        schedule and return-to-ship window.
      </p>
