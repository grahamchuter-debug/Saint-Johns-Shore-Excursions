    ...
    return (
      <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-8 text-center">
        ...
        <p className="mt-2 text-emerald-800">
          Thank you — we&apos;ll respond with St. John&apos;s, Newfoundland and
          Labrador excursion options matched to your ship schedule. Connect your
          preferred email handler in production.
        </p>
      </div>
    );
  }
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        <label className="block">
          ...
          <input
            ...
            name="ship"
            className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2"
            placeholder="e.g. Holland America / Nieuw Statendam"
          />
        </label>
        <label className="block">
          <span className="text-sm font-medium text-slate-700">Port date in St. John&apos;s, NL</span>
          <input
            type="date"
            name="portDate"
            className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2"
      ...
      <label className="block">
        ...
        <textarea
          ...
          rows={4}
          className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2"
          placeholder="Group size, mobility needs, all-aboard time, interests (Signal Hill, puffins, icebergs)…"
        />
      </label>
      <button
        type="submit"
